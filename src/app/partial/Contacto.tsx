      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-lg mx-auto">
          <form className="space-y-4">
            ...
            <button type="submit" className="w-full bg-white text-purple-600 py-2 px-6 rounded-full font-semibold hover:bg-purple-100 transition duration-300">Send Message</button>
          </form>
        </div>
      </div>
    </section>
